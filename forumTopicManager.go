...
func (f *forumTopicManager) Edit(name, iconCustomEmojiId string) (*objs.LogicalResult, error) {
...
func (f *forumTopicManager) Close() (*objs.LogicalResult, error) {
...
func (f *forumTopicManager) Reopen() (*objs.LogicalResult, error) {
...
func (f *forumTopicManager) Delete() (*objs.LogicalResult, error) {
...
func (f *forumTopicManager) UnpinAllMesages() (*objs.LogicalResult, error) {
