...
/*Use this method to create an additional invite link for a chat. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. The link can be revoked using the method RevokeInviteLink. Returns the new invite link as ChatInviteLink object.*/
...
/*Use this method to get information about a member of a chat. Returns a json serialized object of the member in string form on success.*/
