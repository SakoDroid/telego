...
func (f *generalForumTopicManager) Edit(name string) (*objs.LogicalResult, error) {
...
func (f *generalForumTopicManager) Close() (*objs.LogicalResult, error) {
...
func (f *generalForumTopicManager) Reopen() (*objs.LogicalResult, error) {
...
func (f *generalForumTopicManager) Hide() (*objs.LogicalResult, error) {
...
func (f *generalForumTopicManager) Unhide() (*objs.LogicalResult, error) {
...
func (f *generalForumTopicManager) UnpinAllMesages() (*objs.LogicalResult, error) {
